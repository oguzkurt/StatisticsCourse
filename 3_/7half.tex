...
\begin{explanation}
$\alpha=1-0.90=0.10$.
$\Pr(Z\geq z_{0.10})=0.10$ is satisfied for $z_{0.10}=\answer[tolerance=0.001]{1.285}$. Hence, our confidence interval is $z$ \wordChoice{\choice[correct]{less than or equal to} \choice{greater than equal to}} $\answer[tolerance=0.001]{1.285}$.
...
\begin{explanation}
$\alpha=1-0.90=0.10$.
$\Pr(Z\geq z_{0.10})=0.10$ is satisfied for $z_{0.10}=\answer[tolerance=0.001]{1.285}$. Hence, our confidence interval is X \wordChoice{\choice[correct]{less than or equal to} \choice{greater than or equal to}} $\answer[tolerance=0.001]{100+1.285*10}$.
...
\begin{explanation}
$\alpha=1-0.95=0.05$.
$\Pr(Z\leq z_{0.10})=0.05$ is satisfied for $z_{0.10}=\answer[tolerance=0.001]{-1.645}$. Hence, our confidence interval is $z$ \wordChoice{\choice[correct]{greater than or equal to} \choice{less than or equal to}} $\answer[tolerance=0.001]{-1.645}$.
...
\begin{explanation}
$\alpha=1-0.95=0.05$.
$\Pr(Z\leq z_{0.10})=0.05$ is satisfied for $z_{0.10}=\answer[tolerance=0.001]{-1.645}$. Hence, our confidence interval is $X$ \wordChoice{\choice[correct]{greater than or equal to} \choice{less than or equal to}} $\answer[tolerance=0.001]{100-1.645*10}$.
